...
#+AUTHOR: brickviking
#+DATE: <2023-04-27 Thu>
#+TAGS: fossil libfossil fsl fuel pikchr sqlite sqlitecloud forum bash tcl tk httpd
#+REVISION: 2.11
#+OPTIONS: _:nil
#+OPTIONS: toc:2
#+OPTIONS: num:nil
...
function dohelp() {
  ...
  echo "$0 libfossil{-all}: fetches libfossil (libfossil-code) and libfossil-forum"
...
function sqlite-cloud() {
  fossil ${FOSCMD} ${FOSCMDPARAMS[*]} sqlite-cloudsqlite.fossil 
