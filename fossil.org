...
#+BEGIN_SRC bash -i :tangle ~/src/bash/fossil/fossilsource :tangle-mode (identity #o755)
#!/bin/bash
...
#+BEGIN_SRC bash ~/src/bash/fossil/fossilserve :tangle fossilserve :tangle-mode (identity #o755)
#!/bin/bash
...
#+BEGIN_SRC bash :tangle ~/src/bash/fossil/fossilweb.sh :tangle-mode (identity #o755)
#!/bin/bash
...
#+BEGIN_SRC bash :tangle ~/src/bash/fossil/sqliteweb.sh :tangle-mode (identity #o755)
#!/bin/bash
# v0.0.1 FossilWeb - brings up all fossil servers on 8100/8110/8120
...
#+BEGIN_SRC bash :tangle ~/src/bash/fossil/tclweb.sh :tangle-mode (identity #o755)
#!/bin/bash
# v0.0.1 FossilWeb - brings up all fossil servers on 8100/8110/8120
# v0.1.0 Starts up what we choose
# v0.1.2 Removed book from "all" as this very rarely gets updated
...
#+BEGIN_SRC bash :tangle ~/src/bash/fossil/fossilgitcreate :tangle-mode (identity #o644)
#!/bin/bash
...
#+ATTR_LATEX: :options frame=single,backgroundcolor=\color{lightgray}
#+BEGIN_SRC bash :tangle ~/src/bash/fossil/fossilmake :tangle-mode (identity #o644)
#!/bin/bash
#
...
#+ATTR_LATEX: :options frame=single,backgroundcolor=\color{lightgray}
#+BEGIN_SRC bash :tangle ~/src/bash/fossil/fossildoc :tangle-mode (identity #o644)
#!/bin/bash
#
