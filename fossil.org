...
+  2.0 expanded fossilsource to create functions for fetching individual components.
  ...
  +  2.17 Added some stuff like fresh, fuel and inskinerator
...
function dohelp() { # needed renaming, as "help" already exists somewhere else
  ...
  echo "$0 Also includes tangentsoft's inskinerator"
...
# wanderinghorse - a.k.a. libfossil
  ...
  cd ..
# tangentsoft
  cd /home/viking/src/perl/tangentsoft/inskinerator
  inskin
...
# and tangentsoft
    "inskin"|"Inskin"|"inskinerator"|"Inskinerator")
      cd /home/viking/src/perl/hosts/tangentsoft/inskinerator
      inskin
      cd -
    ;;
